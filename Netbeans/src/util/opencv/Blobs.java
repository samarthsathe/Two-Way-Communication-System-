...
public class Blobs
{
    ...
    static int BLOBROWCOUNT =6000 ; // 11 inches * 8.5 inches standard page
    static int BLOBCOLCOUNT = 5000; // with some added cushion to be safe
                ...
                int MinArea)                        // minimum region area
    {
        ...
        {
            System.out.println("Error in Class Blobs: Image too large: Edit Blobs.java "+BLOBCOLCOUNT+" "+Cols+" "+BLOBROWCOUNT+" "+Rows);
            System.exit(666);
            return 0;
        }
